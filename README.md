...
Every assessment creates a real company record in HubSpot — viewable at [https://app-eu1.hubspot.com/contacts/148454999/companies](https://app-eu1.hubspot.com/contacts/148454999/companies) — with the credit decision, score, and recommended limit attached as a note.
...
|---|---|---|
| HubSpot | Real API | Creates a company record for every underwriting decision with lead status and credit decision |
| Xero | Simulated | Returns financial statements including revenue trend, debt ratio, bank balance |
| Apollo | Simulated | Returns company enrichment data including employee count and founding year |
| Credit Bureau | Simulated | Returns FICO-style payment history score and default history |
| GoCardless | Simulated | Returns direct debit mandate setup for approved credit limits |
| Wise | Simulated | Returns supplier payment request marked as awaiting human approval |
